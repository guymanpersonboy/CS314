...
import Anagram_Solver.AnagramMain;
import Anagram_Solver.AnagramSolver;
import Anagram_Solver.LetterInventory;
import Other.Stopwatch;

public class AnagramExtraTests {
	...
	private static void letterInventoryTests() {
		...
		showTestResults(expected, actual, 2,
				" toString on empty LetterInventory");
		...
		showTestResults(expected, actual, 5,
				" isEmpty on empty LetterInventory");

		expected = "";
		actual = lets1.toString();
		showTestResults(expected, actual, 6,
				" LetterInventory toString on empty LetterInventory");
		...
		LetterInventory lets2 = new LetterInventory(
				"\"Stanford University\"!! Jr<>(())G");
		expected = "adefgiijnnorrrssttuvy";
		actual = lets2.toString();
		showTestResults(expected, actual, 8,
				" LetterInventory constructor and toString");
		...
		showTestResults(expected, actual, 13,
				"LetterInventory size after subtract");

		expected = false;
		actual = lets2.isEmpty();
		showTestResults(expected, actual, 14,
				"LetterInventory isEmpty after subtract");
		...
		showTestResults(expected, actual, 19,
				"LetterInventory isEmpty after add");
	...
	private static boolean showTestResults(Object expected, Object actual,
		...
		System.out.println(
				"Test Number " + testNum + " testing " + featureTested);
	...
	private static void runAnagramTests(AnagramSolver solver,
		...
		try {
			...
			// TODO make sure you eventually test all 25 tests
			// (testCaseAnagram first line is 25)
