...
import Code_Camp.CodeCamp;
import Other.Stopwatch;

public class CCExtraTests {
    ...
    public static void main(String[] args) {
        ...
        // test 39, getValueOfMostValuablePlot
         ...
         System.out.println(newline + "Start of extra tests");
         ...
         expectedBool = true;
         actualBool = CodeCamp.queensAreSafe(board);
         System.out.println(newline + "Extra test 1 queensAreSafe: expected value: " + expectedBool
                 + ", actual value: " + actualBool);
         if (expectedBool == actualBool) {
             System.out.println(" passed extra test 1, queensAreSafe");
         } else {
             System.out.println(" ***** FAILED ***** extra test 1, queensAreSafe");
         }
         
         city = new int[][] { {0, -2, -7, 0, -1, -7, -4, -1, -2 ,-8},
        	 				  {-9, -2, -6, -2, 0, -10, 1, 1, -5, -6},
        	 				  {-4, 1, -4, 1, 0, -4, 1, -4, 1, 0},
        	 				  {-1, -8, 0, -2, 1, 0, -2, -7, 0, -1},
        	 				  {-10, 1, 1, -5, -6,-15, -1, 1, 5, 4},
        	 				  {-15, -1, 1, 5, 4, 0, 3, 1, 0, -2},
        	 				  {400, -1, -4, 1, 0, -4, 1, -4, 1, 10},
        	 				  {-1, -8, 0, -2, 1, 0, -2, -7, 20, -1},
        	 				  {-10, 1, 1, -5, -6,-15, -1, 1, 5, 4},
        	 				  {-10, 1, 1, -5, -6,-15, -1, 1, 5, -9} };
        expected = 400;
        actual = CodeCamp.getValueOfMostValuablePlot(city);
        System.out.println("\nExtra test 2 getValueOfMostValuablePlot: expected value: " + expected
        		+ ", actual value: " + actual);
        if (expected == actual) {
        		System.out.println(" passed Extra test 2, getValueOfMostValuablePlot");
        } else {
        	 	System.out.println(" ***** FAILED ***** Extra test 2, getValueOfMostValuablePlot");
        }
